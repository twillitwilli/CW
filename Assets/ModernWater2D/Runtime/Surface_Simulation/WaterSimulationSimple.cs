...
namespace Water2D
{
    public class WaterSimulationSimple : WaterSimulation
    {
        ...
        {
            set { _mainCam = value; }
            get { if (_mainCam == null) _mainCam = Camera.main; return _mainCam; }
        }
        ...
        Vector4 GetObstructionPositions()
        {
            ...
            {
                float extx = (Screen.width- mainCam.pixelWidth ) / 2;
                float exty = (Screen.height- mainCam.pixelHeight ) / 2;

                Vector2 start = new Vector2(extx, exty);

                v1 = cam.ScreenToWorldPoint(new Vector3(start.x, start.y, 0f));
                v2 = cam.ScreenToWorldPoint(new Vector3(start.x + mainCam.pixelWidth, start.y + mainCam.pixelHeight, 0f));
        ...
        public override void Loop()
        {
            ...
            waveShader.SetVector("OstructionTexPos", ObstructionTexPos);
